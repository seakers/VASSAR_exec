...
public class AssigningSearch implements Callable<Algorithm> {
    ...
    public AssigningSearch(Algorithm alg, TypedProperties properties, String savePath, String name, ArchitectureEvaluationManager evalManager) {
        this.alg = alg;
