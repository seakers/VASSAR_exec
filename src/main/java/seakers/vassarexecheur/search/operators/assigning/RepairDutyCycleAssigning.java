...
public class RepairDutyCycleAssigning implements Variation {
    ...
    public RepairDutyCycleAssigning(double threshold, int xInstruments, BaseParams params) {
            ...
            while ((moveCount < xInstruments)) {
                ...
                if (childPayloads.get(satelliteIndex).isEmpty()) {
                    ...
                    //for (int m = 0; m < childPayloads.get(satelliteIndex).size(); m++) {
                        ...
                        //}
                    //}
                    childPayloads.get(candidateSatellites.get(satelliteIndex)).remove(payload);
