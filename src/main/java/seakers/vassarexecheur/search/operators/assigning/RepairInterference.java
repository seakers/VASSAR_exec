...
public class RepairInterference implements Variation{
    ...
    public RepairInterference(int numChanges, ResourcePool resourcePool, ArchitectureEvaluator evaluator, Rete r, QueryBuilder qb, BaseParams params) {
    ...
    public Solution[] evolve(Solution[] sols) {
        ...
        ArrayList<ArrayList<Integer>> possibleInstrumentMoves = getValidMoves(satellites, interferingInstrumentsMap);
    ...
    private ArrayList<ArrayList<Integer>> getValidMoves (ArrayList<Fact> allSatellites, HashMap<String, String[]> interferenceMap) {
            ...
            try {
                ...
                for (int j = 0; j < satelliteInstruments.size(); j++) {
                    ...
                    if (interferenceMapKeys.contains(currentInstrument)) { // If an instrument in the interference Map keyset is present in the satellite
                        ...
                        ArrayList<Integer> presentValueIntegers = checkInstrumentsinSatellite(satelliteInstruments, interferenceMapValues);
