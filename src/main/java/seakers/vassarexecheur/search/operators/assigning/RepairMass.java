 ...
 * If not, one or more instruments are removed from one or more satellites to alleviate the issue.
 *
 * @author roshansuresh
 */
...
public class RepairMass implements Variation {
    ...
    public RepairMass(double threshold, int xInstruments, int ySatellites, BaseParams params) {
