 ...
 * If not, one or more instruments are removed from one or more orbits to try to alleviate the situation
 *
 * @author roshansuresh
 */
...
public class RepairPackingEfficiency implements Variation {
    ...
    public RepairPackingEfficiency(double threshold, int xInstruments, int ySatellites, BaseParams params) {
